...
First: A `char` array is a sequence of characters, just as a vector is a sequence of numbers. Each character in a `char` array is a unique element.
...
.footnote[<sup>1</sup>Note that `Matlab` **does** distinguish between `''` and
