...
Throughout the module, we'll work on some general problem-solving tasks to help you gain experience.
...
several inputs then they would be separated by `,`. For example, let's use the function 
`zeros` to create a matrix with 2 rows and 3 columns:
